...
**Chapter:** 6 — Sales, Payments, Invoices & Receipts (**Phase 6.1E implemented — 6.1 not PO-accepted**; 6.0B PO-accepted)  
...
| 6 | Sales, payments, invoices, receipts | **Phase 6.0B PO-accepted. Phase 6.1 not PO-accepted. Phase 6.1E implemented — awaiting PO hands-on Preview verification.** 6.2 / 6.3 / 6.4 not started. |
