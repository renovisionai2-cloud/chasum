...
**Chapter:** 6 — Sales, Payments, Invoices & Receipts (**Phase 6.0B PO-accepted**; Chapter 5 Phase 5.3 PO-accepted)  
...
| 6 | Sales, payments, invoices, receipts | **Phase 6.0 + 6.0A + 6.0B PO-accepted.** 6.1 / 6.2 / 6.3 / 6.4 not started. |
...
**Phase 6.0 — Money Contract & Source-of-Truth Foundation implemented on Preview.** **Phase 6.0A — Appointment Lifecycle + Collectibility Integrity implemented.** **Chapter 6 Phase 6.0B — Cross-View Calendar Synchronization + Transaction-Linked Refund Flow — PO accepted after hands-on Preview testing.** Contract: [`WORLD_CLASS_COMMERCE_MONEY_ENGINE.md`](./WORLD_CLASS_COMMERCE_MONEY_ENGINE.md). Calendar sync is mutation-wide (CREATE/UPDATE/RESCHEDULE/CANCEL). Refund UX is payment-record driven. Customer cancellation and refund confirmation emails confirmed received. No Stripe Elements. No migrations. Phase 6.1 not started.
...
**Phase 6.0B is PO-accepted.** Do **not** start Phase 6.1 in this lock. Do **not** start Chapter 7. Do not invent Phase 5.4. Do not reopen Phase 5.2, Phase 5.3, or Phase 6.0B for deferred polish. Do not apply gap-report migrations without explicit PO. Do not implement Stripe Elements or public online payment.
