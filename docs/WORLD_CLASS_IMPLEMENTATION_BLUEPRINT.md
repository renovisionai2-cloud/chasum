...
**Chapter:** 6 — Sales, Payments, Invoices & Receipts (**Phase 6.2A = PO ACCEPTED**; **Phase 6.2B = STARTING**; **Phase 6.3 = NOT STARTED**; 6.1 PO-accepted; 6.0B PO-accepted)  
...
| 6 | Sales, payments, invoices, receipts | **Phase 6.0B PO-accepted. Phase 6.1 = PO ACCEPTED. Phase 6.2A = PO ACCEPTED.** Phase 6.2B = STARTING. Phase 6.3 / 6.4 not started. |
...
**Phase 6.0B PO-accepted.** **Phase 6.1 = PO ACCEPTED.** **Phase 6.2A = PO ACCEPTED** after hands-on Preview E2E (RCT-0006; View Appointment read-first; one-location GVM). **Phase 6.2B = STARTING.** **Phase 6.3 = NOT STARTED.** Lock: documents over existing commerce rows. No Stripe Elements. No migrations.
...
**Phase 6.2B STARTING** — commerce document integrity + lifecycle hardening. Do **not** start Phase 6.3. Do **not** start Chapter 7.
