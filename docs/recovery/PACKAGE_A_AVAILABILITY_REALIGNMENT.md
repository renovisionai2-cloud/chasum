...
> 2026-09-14 current-state override: Package A Production apply is ACCEPTED, purpose record `20260913232447_package_a_existing_appointment_interval_correction`; recovery CLOSED and hold OFF. The September 13 pre-apply report below is retained historical evidence. See [Production closeout](./PRODUCTION_RECOVERY_CLOSEOUT_20260914.md). Its former NOT AUTHORIZED / hold ON statements are not current state or instructions to reapply.
