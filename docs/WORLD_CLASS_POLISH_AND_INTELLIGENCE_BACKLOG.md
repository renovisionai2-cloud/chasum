...
- **Chapter 6 Phase 6.2B implemented (PO closeout) — not PO-accepted** (`cb0a809`). Unique appointment/transaction indexes remain PO/database decisions. Historical USD cleanup remains a PO decision. Package entitlement is not built. Do not start Phase 6.3.
