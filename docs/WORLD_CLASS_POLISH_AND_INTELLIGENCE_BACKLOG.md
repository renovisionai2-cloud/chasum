...
- **Chapter 6 Phase 6.2B implemented (integrity + forensic closeout) — not PO-accepted** (`5d30df8`). Unique appointment/transaction indexes remain PO/database decisions. Do not start Phase 6.3.
