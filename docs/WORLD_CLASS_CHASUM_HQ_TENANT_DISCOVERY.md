...
**Database:** Preview ↔ Production **share Supabase** *(historical header at discovery; **LIVE 2026-08-23:** Preview → Staging `wnfahklzaxirftyskctd`; Production → Production `kxcydvhswkuzepwzzinq`. HQ later created in Staging.)*  
