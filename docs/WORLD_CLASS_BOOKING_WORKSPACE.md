...
**Phase 6.2A closeout (PO accepted):** post-booking View Appointment is read-first; one-location GVM skips Location; success hierarchy locked. Do not reopen. Phase 6.2B implemented (PO closeout) — not PO-accepted. Phase 6.3 not started.
