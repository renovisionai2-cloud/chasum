...
**Record owner:** ChatGPT Control Tower. **Prepared:** 2026-09-17; **current reconciliation:** 2026-09-20 after Phase 5 completion, PR #59 direct Production verification, PR #63 Production acceptance, Issue #53 repository governance, Observability Phase A PR #67 Production acceptance, and Observability B2 PR #70 Production acceptance. This manifest preserves dated observations and their limits; it is not an automatic inventory.
...
- Latest accepted application release: `170f0f2608d0e3ed343bafdd4367efdcb604b8a2` (P70-PROD). Vercel Production SUCCESS. PR #67/P67-PROD is the accepted Phase A observability foundation immediately preceding it.
...
| Serving Git SHA | Last directly observed via Production `/api/build-info`: `3629004e05fb0a921ab96954ab701eb4a2f4cd5a` (PR #59). Later accepted releases through `170f0f2608d0e3ed343bafdd4367efdcb604b8a2` deployed successfully, but their serving endpoint was not freshly observed. | UNKNOWN (latest serving endpoint) | P59-PROD direct endpoint; P67-PROD + P70-PROD release acceptance |
| Branch/ref; environment | Last directly observed `main`; `production`; production=true on P59-PROD. Latest accepted P70 release is on Git `main`, but runtime endpoint fields were not freshly observed. | UNKNOWN (latest endpoint) | P59-PROD + P70-PROD |
| Vercel deployment ID | Latest PR #70 Production deployment ID was not captured in the acceptance record; GitHub/Vercel status on merge commit reported SUCCESS. | UNKNOWN | P70-PROD |
...
| Deployment readiness | PR #70 merge commit reported Vercel Production SUCCESS. | MATCH (deployment status only) | P70-PROD |
| Accepted application baseline vs serving | Latest accepted application release is `170f0f260…`; last directly observed serving endpoint identity is `3629004…`. Do not infer endpoint equality from deployment status alone. | UNKNOWN (latest serving endpoint) | P59-PROD + P70-PROD |
| Production SHA vs canonical main | Git main at restamp base = `170f0f260…`; PR #70 Vercel Production deployment succeeded. Latest Production endpoint SHA not freshly observed. | UNKNOWN (latest endpoint) | P70-PROD |
