...
| `/roadmap` | same | Available Today | Calendar & Scheduling | AVAILABLE BUT UNVERIFIED → **Chapter 3** (+ correction: business-TZ ranges; Resources not active) | Low | Keep + portal note | 3 | Preview |
