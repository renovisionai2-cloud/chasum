...
| Employees & staff mgmt | Available Today | `lib/employees/*`, `/dashboard/employees` | Staff login invites Coming Next | Configure employees, roles catalog, schedules |
| Multi-location | Available Today | `lib/actions/location.ts`, plan quotas | Plan max locations | Support one or many locations per plan |
...
| Voice receptionist | Future Vision | Explicit FAQ/roadmap | — | Voice channel reserved—not available |
