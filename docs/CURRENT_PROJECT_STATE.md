...
| Current Git main / Production application release | `06c7d502948a321b706ba07036724c9178e428e7` — PR #93 Package B2 core squash merge. Vercel Production deployment `dpl_HUcbeyiham9KTNftrZCB4QTinu2K` READY. Direct `/api/build-info` HTTP 200 reports this exact SHA on `main`, `env=production`, `production=true`. |
