      ...
      <ul className="grid grid-cols-5 gap-0 px-1 pt-1">
          ...
          return (
            <li key={item.href}>
              <Link
                href={item.href}
                className={cn(
                  "flex min-h-11 flex-col items-center justify-center gap-0.5 rounded-[var(--radius-md)] px-1 text-[10px] font-medium ds-focus-ring",
                  active
                    ? "text-primary"
        ...
        <li>
          <button
            type="button"
            onClick={onMore}
            className="flex min-h-11 w-full flex-col items-center justify-center gap-0.5 rounded-[var(--radius-md)] px-1 text-[10px] font-medium text-muted-foreground hover:text-foreground ds-focus-ring"
