        ...
        <ul className="space-y-2">
          {insights.map((insight) => (
            <li key={insight.id}>
              <Link
                href={insight.href}
                className="block rounded-[var(--radius-md)] border border-border bg-muted/30 px-3 py-2 text-xs transition-colors hover:border-spark/35 hover:bg-spark-muted/40 ds-focus-ring"
              >
