...
export const FAQ_KNOWLEDGE: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    body:
      "Chasum AI is designed to share one Business Brain with role-specific permissions. On the public site, Summer is Chasum's AI Business Manager (Knowledge Engine today; no OpenAI wired yet). AI Receptionist work is one capability within that role. In-product Summer/Chase are Early Access for design partners and must stay grounded in business truth.",
