...
export const FEATURE_KNOWLEDGE: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    category: "features",
    title: "AI Features",
    summary: "Summer (AI Business Manager) & Chase, plus a shared Business Brain roadmap.",
    body:
      "Early Access AI centers on Summer — Chasum's AI Business Manager (discovery, onboarding guidance, operations, staff support, growth; AI Receptionist is one capability) — and Chase (insights). Long-term AI roles share one Business Brain with different permissions — Reception, Manager, Owner, Marketing — without siloed “truth.”",
