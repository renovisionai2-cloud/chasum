/**
 * Portal navigation IA — World Class grouped navigation.
 * Presentation labels and groups; routes stay compatible with existing pages.
 *
 * /dashboard/hq remains the current-main founder-only surface labeled "HQ".
 * Do not relabel it Platform Admin in this Phase 1 integration.
 */
 ...
 * Operate / AI / Business / Account / Advanced.
 */
...
/** Founder-only surface — preserve current-main label. Not Chasum HQ the tenant. */
...
export function isNavItemActive(
  ...
  if (path === "/dashboard/settings") {
    return pathname === path || pathname.startsWith("/dashboard/settings/");
  }
