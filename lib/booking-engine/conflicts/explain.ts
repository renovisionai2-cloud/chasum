...
const EXPLANATIONS: Partial<Record<BookingConflictCode, string>> = {
  ...
  OUTSIDE_EMPLOYEE_HOURS: "That time is outside this employee’s working hours.",
  OUTSIDE_HOURS: "That time is outside allowed hours.",
  ...
  BUSINESS_CLOSURE: "The business is closed during that time.",
  CLOSURE: "The business is closed during that time.",
  MIN_NOTICE: "This time does not meet the minimum booking notice.",
  ...
  DOUBLE_BOOKING: "This conflicts with an existing appointment.",
