...
export const ALPHA_BANNER =
  "Chasum is in Private Alpha — limited design partners, founder support, honest roadmap.";

export const FOUNDER_PRICING_NOTE =
  "Public self-serve billing launches after Private Alpha. Design partners receive founding customer pricing.";
